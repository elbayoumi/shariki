                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge" @error('code') style="border: 1px solid rgb(228, 0, 0); box-shadow: 0 0 3px rgb(228, 0, 0);border-radius:0.3rem" @enderror>
                            ...
                            <input type="text" class="form-control" id="basic-icon-default-fullname" placeholder="Code" name="code" value="{{ old('code') }}">
                          </div>
                        </div>
                      </div>
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group input-group-merge" @error('percent') style="border: 1px solid rgb(228, 0, 0); box-shadow: 0 0 3px rgb(228, 0, 0);border-radius:0.3rem" @enderror>
                            ...
                            <input type="number" class="form-control" id="basic-icon-default-fullname" placeholder="Percent" name="percent" value="{{ old('percent') }}">
                          </div>
                        </div>
                      </div>
                      <div class="row justify-content-center">
                        <div class="col-sm-10 text-center">
                            <button type="submit" class="btn btn-primary mt-3">Add Coupon Code</button>
                        </div>
                    </div>
                    </form>
                  </div>
