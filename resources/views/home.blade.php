...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/css/multiStepsQs.css')}}">
    <style>
        body,
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item mini_title"><a href="index.html"><i class="ft-home"></i><span class="menu-title "
                            data-i18n="">خاص بي </span></a>
                </li>
                <li class=" nav-item"><a href="/termsAndConditions.html"><i class="ft-layers"></i><span class="menu-title"
...
<!-- <div class="navigation-background"></div> -->
    ...
    <!-- <div class="app-content content">
        <div class="content-wrapper">
            ...
            <header class="header">
                <h1 class="header__title title "> بيانات مقدم الطلب – الباحث عن زوجة لنتعرف عليك اكثر </h1>
              </header>
